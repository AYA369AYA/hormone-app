...
export default async function Page({
  ...
  let result = {
    ...
    title: "回復と消耗のバランスが保たれている状態です",
    body: `今のあなたの身体は、大きな無理なくエネルギーを使えている状態です。

整っているときほど、小さな違和感に気づくことが、これからの余白を守ります。`,
    cta: "今の状態を保ちながら整えたい方へ",
  };
  ...
  if (score >= 15 && score < 30) {
    result = {
      ...
      title: "エネルギーの使い方に変化のサインが見られます",
      body: `朝の重さや、夕方の疲れ、甘いものやコーヒーに頼りたくなる感覚は、
身体が少し無理をしているときに出やすいサインです。
...
この段階で気づけることが、回復に戻る自然な入口になります。`,
  ...
  if (score >= 30) {
    result = {
      ...
      title: "エネルギー消耗が先行している状態です",
      body: `この状態では、休んでいても身体がゆるみきらず、
回復している感覚が得られにくくなります。

まずは何かを足すよりも、
どこに力を使いすぎているかに気づくことが大切です。`,
      ...
      <main style={styles.main}>
        <div style={styles.card}>
          ...
          <div style={styles.cta}>
            <p>{result.cta}</p>
            <p>
              唾液ホルモン検査では、ホルモンバランスやストレスリズムを確認しながら、
              今の体の状態をより具体的に見ていきます。
            </p>
          </div>
