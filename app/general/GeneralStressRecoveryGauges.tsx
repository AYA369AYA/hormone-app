...
/**
 * /general専用の、ラグジュアリー・エディトリアル仕様のリングゲージ。
 * ロジック・文言は元のStressRecoveryGaugesと同一、見た目のみ調整。
 */
export function GeneralStressRecoveryGauges({
  stress,
  recovery,
  disclaimer,
}: {
  ...
  return (
    <div style={styles.wrapper}>
      <p style={styles.title}>SELF-CHECK RESULT</p>
      <p style={styles.subtitle}>セルフテストから見える、今の身体の傾向</p>
    ...
    <div style={styles.gaugeItem}>
      <div style={styles.gaugeSvgWrap}>
        <svg viewBox="0 0 100 100" style={styles.gaugeSvg} aria-hidden="true">
          <circle cx="50" cy="50" r={radius} fill="none" stroke="rgba(198,169,107,0.14)" strokeWidth="4" />
          <circle
            cx="50"
            cy="50"
            r={radius}
...
const styles: Record<string, CSSProperties> = {
  wrapper: {
    ...
    borderRadius: 22,
    background:
      "radial-gradient(circle at 50% 0%, oklch(88% .05 85 / 0.28) 0%, transparent 70%), oklch(98.5% .008 85)",
